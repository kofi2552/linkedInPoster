...
export function ProfileSettings({
  ...
  const handleSave = async (e) => {
    ...
    if (!validation.success) {
      ...
      const lengthError = issues.find((i) => i.code === "too_small")?.message;
  ...
  if (loading)
    return (
      <div className="w-full h-[50vh] mx-auto p-8 flex items-center justify-center flex-col">
    ...
    <div className="max-w-4xl mx-auto space-y-6">
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground">
          Manage your contact details and account status.
        </p>
      </div>
      ...
      <Card className="p-6 space-y-6">
        ...
        <form onSubmit={handleSave} className="space-y-4">
          ...
          <div className="grid gap-2">
            <Label htmlFor="phone">
              WhatsApp/Phone/Telegram Number{" "}
            ...
            <p className="text-[10px] text-muted-foreground">
              Required for Premium upgrades and support.
            </p>
          </div>
